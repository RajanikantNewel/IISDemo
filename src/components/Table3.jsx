...
const Table3 = ({ tableData, headings,userId,onRowClick ,setTableData,setDistributorNameInput,setSelectedFile,setFundNameInput,onFileDownload}) => {
    ...
    return (
        <div className="distributor-master-table">
            {tableData.length > 0 && (
                <>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", marginBottom: "5px",marginTop:"20px" }}>
